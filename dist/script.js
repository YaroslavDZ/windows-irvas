...
window.addEventListener('DOMContentLoaded', () => {
  ...
  Object(_modules_timer_js__WEBPACK_IMPORTED_MODULE_5__["default"])('.timer1', deadline);
  Object(_modules_images_js__WEBPACK_IMPORTED_MODULE_6__["default"])();
});
...
const forms = state => {
  ...
  form.forEach(item => {
    item.addEventListener('submit', e => {
      ...
      postData('/dist/assets/server.php', formData).then(res => {
        console.log(res);
